        ...
        <Nav tabs>
          ...
          <NavItem>
            <NavLink
              ...
              onClick={() => { this.toggle('1'); }}
            >
               <p style={{color: "#ef5635"}}><b>Recruit 3 more travel accounts, earn points to travel any destination within African continent</b></p>
            </NavLink>
          </NavItem>
        </Nav>
               ...
               <Table borderless>
                            <thead>
                              <tr>
                                ...
                                <th></th>
                                <th></th>
                                <th> <span style={{marginLeft: "0px", alignItems: "right"}}>PACKAGE: <span style={{color: "#FFD700"}}>GOLD</span></span></th>
                              </tr>
                            </thead>
                 </Table>
              </Row>
